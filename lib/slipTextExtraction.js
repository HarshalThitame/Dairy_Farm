...
function normalizeStructuredSlip(aiJson, ocr = {}) {
  ...
  const morningTotalLiters =
    readSessionTotal(aiJson, "morning", [
      ...
      "sakal_liters",
      "sakalche_total_dudh"
    ]) ?? sessionTotalLiters(sessionEntries, "सकाळ");
  const eveningTotalLiters =
    readSessionTotal(aiJson, "evening", [
    ...
    ]) ?? sessionTotalLiters(sessionEntries, "संध्याकाळ");
  ...
  return {
    ...
    total_liters: parseNumber(aiJson.total_liters ?? aiJson.daily_total_liters) ?? combinedSessionTotal,
    ...
    settlement_validation: {
      ...
      summary_total_liters: parseNumber(aiJson.total_liters ?? aiJson.daily_total_liters),
