...
export const ticketCategories = [
  ...
  { id: "subscription_issue", label: "Subscription Issue" },
  { id: "data_issue", label: "Data Issue" },
  { id: "ai_assistant_issue", label: "AI Assistant Issue" },
  { id: "ocr_issue", label: "OCR Issue" },
...
export const ticketStatuses = [
  ...
  { id: "waiting_for_user", label: "User उत्तर बाकी" },
...
export const featureStatuses = [
  ...
  { id: "released", label: "Release झाले" },
  { id: "rejected", label: "नाकारले" }
];
