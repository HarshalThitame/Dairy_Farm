...
export function estimateThermalPaperAge(confidenceScore) {
  ...
  if (score > 0.75) {
    return { age: "Needs review", warning: "AI खात्री मध्यम आहे. फोटो स्पष्ट असला तरी आकडे एकदा तपासा." };
  }

  return { age: "Low confidence", warning: "AI खात्री कमी आहे. फोटो स्पष्ट असला तरी वाचलेले आकडे स्वतः तपासून भरा." };
}
