...
<head>
  <meta charset="utf-8" />
  <title>गोशाळा व्यवस्थापन अहवाल</title>
  <style>
...
<body>
  ...
  ${
    include("finance")
      ? `<section><h2>हिशोब सारांश</h2><p>उत्पन्न: ${escapeHTML(formatCurrency(finance.totalIncome || 0))}</p><p>खर्च: ${escapeHTML(formatCurrency(finance.totalExpense || 0))}</p><p>नफा: ${escapeHTML(formatCurrency(finance.netProfit || 0))}</p></section>`
      : ""
  }
  ${
    include("performance")
