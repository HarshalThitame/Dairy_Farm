...
export async function replaceCachedSettlements(records, start, end, farmId = getCurrentFarmId()) {
  return replaceAccountingRecords("settlements_cache", records, "settlement_date", start, end, farmId);
}

export async function getCachedSettlements(start, end, farmId = getCurrentFarmId()) {
  return getAccountingRecordsByMonth("settlements_cache", "settlement_date", start, end, farmId);
}
